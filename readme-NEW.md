...
| [GitHub Actions](https://github.com/DayOne-Dev/spring-petclinic/actions/workflows/frogbot-scan-repository.yml) | JFrog [Frogbot](https://github.com/jfrog/frogbot) Scan and Fix | [![Frogbot Scan and Fix](https://github.com/DayOne-Dev/spring-petclinic/actions/workflows/frogbot-scan-repository.yml/badge.svg)](https://github.com/DayOne-Dev/spring-petclinic/actions/workflows/frogbot-scan-repository.yml) | Not Yet | 
